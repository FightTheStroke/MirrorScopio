...
2. **Esposizione dei dati di chi usa l'app** — nome, cronologia degli errori,
   referti — a un altro utente del Mac o a un'altra applicazione.
...
Sono file JSON in chiaro, dentro la cartella dell'utente, protetti dai permessi
del sistema operativo come qualsiasi altro documento. **Non sono cifrati.** È
una scelta consapevole: chi tiene a questi dati deve poterli leggere, copiare e
cancellare senza chiedere il permesso a nessuno, incluso a noi. Per cancellare
tutto basta buttare quella cartella.
...
- **In entrata**, alla prima esecuzione, macOS può scaricare da Apple il modello
  di riconoscimento vocale italiano. È un download del sistema operativo, non
  contiene dati tuoi, e avviene una volta sola. Dopo, l'app funziona senza
  internet.
